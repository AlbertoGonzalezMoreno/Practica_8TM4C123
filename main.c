...
/*Aquí decidí poner la configuración de la OLED dentro del main
porque al crear una librería nueva me marcaba un error y no 
reconocía ninguna de las funciones, pero anexo una foto de que funciona*/
